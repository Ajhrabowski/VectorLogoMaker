...
class renderTriangle extends Shape {
  ...
  render (){
    ...
    return `<svg xmlns="http://www.w3.org/2000/svg" width="300" height="300">
      ...
      <text x="150" y="125" font-size="30" fill="${this.textColor}" text-anchor="middle">${this.text}</text>
      </svg>`;
  }
}
...
class renderSquare extends Shape {
  ...
  render(){
    ...
    return `<svg xmlns="http://www.w3.org/2000/svg" width="210" height="500">
      <rect width="100" height="100" fill="${this.color}" />
      <text x="50" y="60" font-size="30" fill="${this.textColor}" text-anchor="middle">${this.text}</text>
      </svg>`;
  }
}
